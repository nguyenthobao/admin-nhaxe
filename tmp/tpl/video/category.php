<?php 
					 ...
					 * @File /data/www/superweb/ad/tmp/tpl/video/category.php 
...
<a href="<?=$_B['home']?>/video-categorylist-lang-vi" class="btn default"><i class="fa fa-angle-left"></i> <?php echo lang('cancel');?></a>
...
<input type="hidden" name="action" value="addCategoryVideo">
...
<div class="col-md-8">
<input type="text" class="form-control maxlength-handler" id="seo_url" onkeyup="trim_name(this);" name="title" maxlength="60" value="<?=$cat['title']?>" placeholder="" data-error="<?php echo lang('title_error');?>">
...
<?php } ?>
<div class="form-group">
<label class="col-md-2 control-label"><?php echo lang('description');?> 
</label>
<div class="col-md-8">
<textarea class="form-control " rows="6" name="description"  data-error="<?php echo lang('description_error');?>"><?=$cat['description']?></textarea>
</div>
</div>
...
<option value="0"><?php echo lang('categorygoc');?></option>
<?php if(isset($category)) { ?>
<?php if(is_array($category)) { foreach($category as $k => $v) { ?>

<option value="<?=$v['id']?>" <?php if($v['id']==$cat['parent_id']) { ?>selected="selected"<?php } ?> > <?=$v['title']?> </option>
...
<p class="labeltbl"><?php echo lang('icon_img');?></p>
...
<p class="labeltbl" ><?php echo lang('bg_img');?></p>
<?php if(!empty($cat['bg'])) { ?>
...
<div class="form-group">
<label class="control-label col-md-2"><?php echo lang('active_tc');?> 
</label>
<div class="col-md-2">
<select class="form-control" name="status_home" data-error="<?php echo lang('category_error');?>">
<?php if(empty($cat['id']) ) { ?>
<option value="1" selected="selected">
<?php echo lang('active_home_text');?>
</option>
<option value="0"><?php echo lang('non_active_home');?></option>
<?php } else { ?>
<option value="1" 
<?php if($cat['status_home']==1) { ?>selected="selected"
<?php } ?> >
<?php echo lang('active_home_text');?>
</option>
<option value="0" <?php if($cat['status_home']==0 ) { ?>selected="selected"<?php } ?>><?php echo lang('non_active_home');?></option>
<?php } ?>
</select>
</div>
</div>
...
<div class="form-group">
<label class="col-md-2 control-label"><?php echo lang('number_home');?>:
</label>
<div class="col-md-2">
<input type="text" onkeypress='validate(event)' class="form-control" name="number_home" data-error="<?php echo lang('number_error');?>" value="<?=$cat['number_home']?>" >
</div>
</div>
<div class="form-group">
...
<div class="col-md-2">
<input onkeypress='validate(event)' type="text" class="form-control" name="sort" data-error="<?php echo lang('number_error');?>" value="<?=$cat['sort']?>" >
</div>
</div>
<div class="form-group">
...
<?php } else { ?>
<option value="1" <?php if($cat['status']==1) { ?>selected="selected"<?php } ?> ><?php echo lang('act');?></option>
<option value="0" <?php if($cat['status']==0) { ?>selected="selected"<?php } ?>><?php echo lang('none_act');?></option>
<?php } ?>
</select>
</div>
</div>
