<?php 
					 ...
					 * @File /data/www/superweb/ad/tmp/tpl/template/blocksocial.php 
...
<div class="caption">
<i class="fa fa-navicon"></i><?php echo lang('block_mang_xh');?>
</div>
...
<td class="icon_btn">
<a href="/template-social-edit-<?=$v['id']?>-lang-<?=$_GET['lang']?>" class="btn default btn-xs yellow " data-placement="top" data-original-title="<?php echo lang('edit');?>"><i class="fa fa-edit"></i></a>
