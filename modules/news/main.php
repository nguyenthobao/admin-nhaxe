...
$pages = array('category','categorylist','news','ajax','demophantrang','sendmailsmtp','newslist','ajaxnews','setting','loadnews','ajaxLoad','viewnews');
$page = $_B['r']->get_string('page','GET');
if (!in_array($page, $pages)) {
	$page = 'home';
	
}
include_once(DIR_MODULES.$mod."/model/global_news.php");//Load model dùng chung (nếu function nào dùng dung thì viết vào model này)
