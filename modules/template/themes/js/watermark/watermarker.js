...
;(function($){
	...
	$.watermarker = function(object, userOptions){
		...
		var drag = function(event){
			...
			var nxtPosThis=getPositionData($('.watermarker-container'));
			var nxtPosImg=getPositionData($('#image'));
			var nxtPosX=parseInt(nxtPosThis.left-nxtPosImg.left);
			var nxtPosY=parseInt(nxtPosThis.top-nxtPosImg.top);
			var percentX=parseFloat(nxtPosX/nxtPosImg.width);
			var percentY=parseFloat(nxtPosY/nxtPosImg.height);
			var posX=parseInt(percentX*100);
			var posY=parseInt(percentY*100);
			
			// console.log(getPositionData($('.watermarker-container')));
		...
		var resize = function(event){
			...
			$("#width").val(checkWidth(width,element));
        	$("#height").val(checkHeight(height,element));
		}
