 ...
 (function ($) {
    ...
    $.fn.uploadFile = function (options) {
        ...
        var s = $.extend({
            ...
            placeholderTextWidth: "Width...",
            placeholderTextHeight: "Height...",
            placeholderTextLink: "Link...",
        ...
        function createProgressDiv(obj, s) {
            ...
            this.progressImg = $("<div class='ajax-file-upload-file'><img alt='" + s.loadingStr + "' src='' width='' /><div class='placeholderStatus'>" + s.loadingStr + "</div></div>").appendTo(this.statusbar);
            ...
            this.input = $("<div class='ajax-file-upload-input'><input type='text' name='name_img' placeholder='" + s.placeholderTextStr + "' /></div>").appendTo(this.statusbar);            
            this.textarea = $("<div class='ajax-file-upload-textarea'><textarea placeholder='" + s.placeholderTextAreaStr + "'></textarea></div>").appendTo(this.statusbar);
            this.inputWidth = $("<div class='ajax-file-upload-input'><input type='text' name='width' placeholder='" + s.placeholderTextWidth + "' /></div>").appendTo(this.statusbar);
            this.inputHeight = $("<div class='ajax-file-upload-input'><input type='text' name='height' placeholder='" + s.placeholderTextHeight + "' /></div>").appendTo(this.statusbar);
            this.inputLink = $("<div class='ajax-file-upload-input'><input type='text' name='link' placeholder='" + s.placeholderTextLink + "' /></div>").appendTo(this.statusbar);
                ...
                beforeSubmit: function (formData, $form, options) {
                    if (s.onSubmit.call(this, fileArray) != false) {
                        ...
                        success: function (data, message, xhr) {
                            ...
                            var title = pd.input.find('input[name="name_img"]');
                                title.keyup (function() {
                                if(s.titleCallback) s.titleCallback.call(this,data,title.val());
                            });
                            var width = pd.inputWidth.find('input[name="width"]');
                                width.keyup (function() {
                                if(s.widthCallback) s.widthCallback.call(this,data,width.val());
                            });
                            var height = pd.inputHeight.find('input[name="height"]');
                                height.keyup (function() {
                                if(s.heightCallback) s.heightCallback.call(this,data,height.val());
                            });
                            var link = pd.inputLink.find('input[name="link"]');
                                link.keyup (function() {
                                if(s.linkCallback) s.linkCallback.call(this,data,link.val());
                            });
