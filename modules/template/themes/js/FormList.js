...
var FormList = function () {
    ...
    var fastEdit = function(){
        ...
        $.fn.editable.defaults.inputclass = 'form-control';
            $('.slideItem').editable({
                url: 'template-customForm-ajaxChangeTitle-lang-'+lang,
                type: 'text',
    ...
    var handleStatus = function() {
        $('body').on('click', '.status_item', function(event) {
            ...
            var urlSend = '/template-customForm-ajaxEditStatus';
    ...
    var deleteSlide = function(){
        $('.delete_slide').click(function(){
            ...
            bootbox.dialog({
                message: '<li class="list-group-item list-group-item-warning">Cảnh báo. Khi xóa form này thì trên trang chủ sẽ không hiển thị</li>',
                title: "Xoá form",
                buttons: {
                  success: {
                    label: "Đồng ý",
                    ...
                    callback: function() {
                        ...
                        var urlSend='/template-customForm-ajaxDelete';
    ...
    var deleteMultiID =function(){
        $('.delete_slide_select').click(function(){
            bootbox.dialog({
                message: '<li class="list-group-item list-group-item-warning">Cảnh báo: Xóa tất cả các form đã chọn, Khi xóa tất cả form này thì trên trang chủ sẽ không hiển thị. Bạn có chắc chắn xoá ?</li>',
                title: "Xoá form",
                buttons: {
                    success: {
                    label: "Đồng ý",
                    ...
                    var all=[];
                        ...
                        var urlSend='/template-customForm-ajaxMultiDelete';
                        var data=ajax_global(dataString,urlSend,'POST','json');
                        if(data.status==true){
    ...
    var handleOnload=function(){
        $('select[name="nxt_lang_copy"] > option[value="'+lang+'"]').remove();
    }
