...
$pages = array('category','categorylist','video','videolist','ajax','ajaxvideo','setting');
$page = $_B['r']->get_string('page','GET');
if (!in_array($page, $pages)) {
	$page = 'home';
} 
include_once(DIR_MODULES.$mod."/model/global_video.php");//Load model dùng chung (nếu function nào dùng dung thì viết vào model này)
